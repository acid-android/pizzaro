            ...
            <main id="main" class="site-main" >
                                                    ...
                                                    <div class="product-inner">
                                                        ...
                                                        <div class="product-content-wrapper">
                                                            ...
                                                            <div class="hover-area">
                                                                <a rel="nofollow" href="{{route('product')}}" data-quantity="1" data-product_id="51" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="stretch-full-width section-products-sale-event"  style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/5.jpg ); height: 468px;">
                    <div class="sale-event-content">
                        ...
                        <a href="{{route('product')}}" class="button">Order Now</a>
                    </div>
                </div>
                <div class="section-products">
                ...
                <div class="section-product"  style="background-size: cover; background-image: url( assets/images/homepage-banners/6.png ); height: 556px;">
                    <div class="product-wrapper">
                        <div class="product-inner">
                            ...
                            <a rel="nofollow" href="{{route('product')}}" data-quantity="1" data-product_id="82" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>
                        </div>
                    </div>
                </div>
