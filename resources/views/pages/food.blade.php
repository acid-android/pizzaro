                                ...
                                <div class="product-inner">
                                    <div class="product-image-wrapper">
                                        <a href="{{route('product')}}" class="woocommerce-LoopProduct-link">
                                            <img src="{{asset($product->image)}}" width="350" height="350" class="img-responsive" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content-wrapper">
                                        ...
                                        <div class="hover-area">
                                            <a rel="nofollow" href="{{route('product')}}" data-quantity="1" data-product_id="{{ $product->id }}" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
