...
@section('body-class', 'blog right-sidebar single single-post')
    ...
    <div class="col-full">
        <div class="pizzaro-breadcrumb">
            <nav class="woocommerce-breadcrumb" itemprop="breadcrumb">
                ...
                <a href="#">Technology</a>
                <span class="delimiter"><i class="po po-arrow-right-slider"></i></span>Pizza Festival – Reopen
            </nav>
        </div>
            ...
            <main id="main" class="site-main" >
                <article id="post-359" class="post-359 post type-post status-publish format-image has-post-thumbnail hentry category-technology tag-event tag-festival tag-music tag-woocommerce post_format-post-format-image">
                    <header class="entry-header">
                        ...
                        <h1 class="entry-title">Pizza Festival – Reopen</h1>
