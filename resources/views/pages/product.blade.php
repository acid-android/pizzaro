...
@section('body-class', 'single-product style-1 woocommerce')
    ...
    <div class="col-full">
        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main" >
                <div itemscope itemtype="http://schema.org/Product" id="product-{{ $product->id }}" class="post-50 product type-product status-publish has-post-thumbnail product_cat-pizza pa_food-type-veg first instock shipping-taxable purchasable product-type-simple addon-product">
                    <div class="single-product-wrapper">
                        <div class="product-images-wrapper">
                            <div class="images">
                                <a href="{{ asset($product->image) }}" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto[product-gallery]">
                                    <img width="600" height="600" src="{{ asset($product->image) }}" class="attachment-shop_single size-shop_single wp-post-image" alt=""/>
                                </a>
                                <div class="thumbnails columns-4">
                                    <a href="{{ asset($product->image) }}" class="zoom first" title="" data-rel="prettyPhoto[product-gallery]">
                                        <img width="180" height="180" src="{{ asset($product->image) }}" class="attachment-shop_thumbnail size-shop_thumbnail" alt=""/>
                                    </a>
                                    <a href="{{ asset($product->image) }}" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
                                        <img width="180" height="180" src="{{ asset($product->image) }}" class="attachment-shop_thumbnail size-shop_thumbnail" alt=""/>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="summary entry-summary">
                            ...
                            <form class="cart"  enctype='multipart/form-data'>
                                <div  class="yith_wapo_groups_container" style="margin: 0">
