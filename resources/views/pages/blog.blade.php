...
@section('body-class', 'blog right-sidebar')
    ...
    <div class="col-full">
        <div class="pizzaro-breadcrumb">
            <nav class="woocommerce-breadcrumb" >
                <a href="{{route('article')}}">Home</a><span class="delimiter"><i class="po po-arrow-right-slider"></i></span>Blog
            </nav>
        </div>
                ...
                <div class="posts">
                    <article id="post-359" class="post-359 post type-post status-publish format-image has-post-thumbnail sticky hentry category-technology tag-event tag-festival tag-music tag-woocommerce post_format-post-format-image">
                        <header class="entry-header">
                            ...
                            <h1 class="alpha entry-title">
                                <a href="{{route('article')}}" rel="bookmark">Pizza Festival – Reopen</a>
                            </h1>
                            <div class="entry-meta">
                                <div class="cat-links">
                                    <a href="{{route('article')}}" rel="category tag">Technology</a>
                                </div>
                                <span class="posted-on">
                                 <a href="{{route('article')}}" rel="bookmark">
                                 <time class="entry-date published" datetime="2016-10-13T14:53:25+00:00">October 13, 2016</time>
                                 </a>
                                 </span>
                                <div class="author">
                                    <div class="label">Posted by:</div>
                                    <a href="{{route('article')}}" title="Posts by farook" rel="author">farook</a>
                                </div>
                            </div>
                        </header>
                        <!-- .entry-header -->
                        <div class="entry-content">
                            ...
                            <div class="post-readmore">
                                <a href="{{route('article')}}" class="read-more-text">Read More</a>
                            </div>
                    ...
                    <article id="post-356" class="post-356 post type-post status-publish format-audio hentry category-design category-music category-social tag-audio tag-awsome tag-buy-it tag-music  post_format-post-format-audio">
                        <header class="entry-header">
                            ...
                            <h1 class="alpha entry-title">
                                <a href="{{route('article')}}" rel="bookmark">Music for Dinner &#8211; Audio Player</a>
                            </h1>
                            <div class="entry-meta">
                                <div class="cat-links">
                                    <a href="{{route('article')}}" rel="category tag">Design</a>,
                                    <a href="{{route('article')}}" rel="category tag">Music</a>,
                                    <a href="{{route('article')}}" rel="category tag">Social</a>
                                </div>
                                <span class="posted-on">
                                 <a href="{{route('article')}}" rel="bookmark">
                    ...
                    <article id="post-354" class="post-354 post type-post status-publish format-video hentry category-videos tag-awsome tag-buy-it  tag-video tag-wordpress post_format-post-format-video">
                        <header class="entry-header">
                            ...
                            <h1 class="alpha entry-title">
                                <a href="{{route('article')}}" rel="bookmark">This is how we Baking our Pizza &#8211; Video Post</a>
                            </h1>
                            <div class="entry-meta">
                                <div class="cat-links">
                                    <a href="{{route('article')}}" rel="category tag">Videos</a>
                                </div>
                                <span class="posted-on">
                                 <a href="{{route('article')}}" rel="bookmark">
                    ...
                    <article id="post-255" class="post-255 post type-post status-publish format-standard hentry category-uncategorized">
                        <header class="entry-header">
                            <h1 class="alpha entry-title">
                                <a href="{{route('article')}}" rel="bookmark">Iced Caramel Latte</a>
                            </h1>
                            <div class="entry-meta">
                                <div class="cat-links">
                                    <a href="{{route('article')}}" rel="category tag">Uncategorized</a>
                                </div>
                                <span class="posted-on">
                                 <a href="{{route('article')}}" rel="bookmark">
                    ...
                    <article id="post-251" class="post-251 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized">
                        <header class="entry-header">
                            ...
                            <h1 class="alpha entry-title">
                                <a href="{{route('article')}}" rel="bookmark">5th International Pizza Festival with New Better Competitors from All over the World.</a>
                            </h1>
                            <div class="entry-meta">
                                <div class="cat-links">
                                    <a href="{{route('article')}}" rel="category tag">Uncategorized</a>
                        ...
                        <div class="entry-content">
                            ...
                            <span class="comments-link">
                              <a href="{{route('article')}}">Leave a comment</a>
                              </span>
                        </div>
                    </article>
                    <!-- #post-## -->
        ...
        <div id="secondary" class="widget-area" role="complementary">
            ...
            <div id="search-2" class="widget widget_search">
                <form role="search" method="get" class="search-form" action="{{route('article')}}">
                    <label>
                ...
                <ul>
                    <li>
                        ...
                        <div class="post-content">
                            ...
                            <a class ="post-name" href="{{route('article')}}">Pizza Festival – Reopen</a>
                        </div>
                    </li>
                    <li>
                        <div class="post-thumbnail">
                        ...
                        <div class="post-content">
                            ...
                            <span class="post-date">October 13, 2016</span>
                            <a class ="post-name" href="{{route('article')}}">Music for Dinner &#8211; Audio Player</a>
                        </div>
                    </li>
                </ul>
            </div>
